...
/**
 * @typedef { {playlistWindow: {event: {Ready: null, PlayRequested: null, PauseRequested: null, StopRequested: null, TrackLoaded: SpotifyTrack, EndReached: null, DragStarted: null, DragEnded: null, LocalFilesPicked: string[]}}, playerWindow: {event: {CloseRequested: null, UrlsDropped: string[], NextPressed: null, PreviousPressed: null, DragStarted: null, DragEnded: null }}, player: { event: { 'Paused': { uri: string, position_ms: number}, 'Playing': { uri: string, position_ms: number}, 'Stopped': {uri: string}, 'EndOfTrack': {uri: string}, 'PositionCorrection': { uri: string, position_ms: number}, 'PositionChanged': { uri: string, position_ms: number}, 'Seeked': { uri: string, position_ms: number}} }} } WindowEventTypes
 */
